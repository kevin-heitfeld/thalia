...
class TestThetaOscillator:
    """Tests for theta oscillator (8 Hz)."""
    ...
    def test_phase_advancement(self):
        ...
        theta = ThetaOscillator(frequency_hz=8.0, dt_ms=1.0)
    ...
    def test_oscillation_period(self):
        ...
        theta = ThetaOscillator(frequency_hz=10.0)
        assert abs(theta.oscillation_period_ms - 100.0) < 0.1
    
    def test_signal_generation(self):
        """Test sinusoidal signal generation."""
        theta = ThetaOscillator(frequency_hz=8.0, amplitude=1.0)
    ...
    def test_state_management(self):
        ...
        theta2 = ThetaOscillator(frequency_hz=5.0)
    ...
    def test_reset_state(self):
        ...
        theta = ThetaOscillator(frequency_hz=8.0, initial_phase=0.0)
...
class TestGammaOscillator:
    """Tests for gamma oscillator (40 Hz)."""
    
    def test_creation(self):
        """Test gamma oscillator creation."""
        gamma = GammaOscillatorBase(frequency_hz=40.0)
    ...
    def test_signal_generation(self):
        ...
        gamma = GammaOscillatorBase(frequency_hz=40.0, amplitude=1.0)
...
class TestAlphaOscillator:
    """Tests for alpha oscillator (10 Hz)."""
    
    def test_creation(self):
        """Test alpha oscillator creation."""
        alpha = AlphaOscillator(frequency_hz=10.0)
        assert alpha.frequency_hz == 10.0
        assert abs(alpha.oscillation_period_ms - 100.0) < 0.1


class TestBetaOscillator:
    """Tests for beta oscillator (20 Hz)."""
    
    def test_creation(self):
        """Test beta oscillator creation."""
        beta = BetaOscillator(frequency_hz=20.0)
        assert beta.frequency_hz == 20.0
        assert abs(beta.oscillation_period_ms - 50.0) < 0.1


# ============================================================================
# Oscillator Factory Tests
# ============================================================================

class TestOscillatorFactory:
    """Tests for oscillator factory function."""
    
    def test_create_theta(self):
        """Test creating theta oscillator via factory."""
        theta = create_oscillator('theta', frequency_hz=8.0)
        assert isinstance(theta, ThetaOscillator)
        assert theta.frequency_hz == 8.0
    
    def test_create_gamma(self):
        """Test creating gamma oscillator via factory."""
        gamma = create_oscillator('gamma', frequency_hz=40.0)
        assert isinstance(gamma, GammaOscillatorBase)
        assert gamma.frequency_hz == 40.0
    
    def test_create_alpha(self):
        """Test creating alpha oscillator via factory."""
        alpha = create_oscillator('alpha')
        assert isinstance(alpha, AlphaOscillator)
        assert alpha.frequency_hz == 10.0
    
    def test_create_beta(self):
        """Test creating beta oscillator via factory."""
        beta = create_oscillator('beta')
        assert isinstance(beta, BetaOscillator)
        assert beta.frequency_hz == 20.0
    
    def test_invalid_type(self):
        """Test error on invalid oscillator type."""
        with pytest.raises(ValueError, match="Unknown oscillator type"):
            create_oscillator('invalid')
    
    def test_custom_parameters(self):
        """Test passing custom parameters via factory."""
        theta = create_oscillator('theta', frequency_hz=6.0, amplitude=2.0)
        assert theta.frequency_hz == 6.0
        assert theta.config.amplitude == 2.0


# ============================================================================
# Oscillator Interaction Tests
# ============================================================================
...
class TestOscillatorEdgeCases:
    ...
    def test_very_high_frequency(self):
        ...
        high_gamma = GammaOscillatorBase(frequency_hz=100.0)
    ...
    def test_very_low_frequency(self):
        ...
        slow = ThetaOscillator(frequency_hz=1.0)
    ...
    def test_amplitude_scaling(self):
        ...
        theta = ThetaOscillator(frequency_hz=8.0, amplitude=2.0)
