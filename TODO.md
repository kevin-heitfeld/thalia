...
- [ ] Clean-up config system
  - Consolidate overlapping config parameters
  - Remove unused configuration options
  - Document configuration hierarchy

### Training & Validation
- [ ] Run Stage -0.5 sensorimotor training with full oscillatory coordination
  - Use beta-gamma coupling for motor precision
  - Validate alpha-gamma attention gating
  - Test theta-gamma working memory
