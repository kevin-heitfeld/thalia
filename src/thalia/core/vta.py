...
class VTAConfig:
    ...
    homeostatic_config: Optional[HomeostaticConfig] = None
...
class VTADopamineSystem:
    ...
    def __init__(self, config: Optional[VTAConfig] = None):
        ...
        homeostatic_cfg = self.config.homeostatic_config or HomeostaticConfig(target_level=0.0)
        self._homeostatic = HomeostaticRegulator(config=homeostatic_cfg)
