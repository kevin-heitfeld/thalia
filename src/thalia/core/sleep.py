...
class SleepSystemMixin:
    ...
    def sleep_epoch(
        ...
        for cycle_idx in range(n_cycles):
            ...
            n2_metrics = self._run_stage_replays(SleepStage.N2, n_n2, n_timesteps)
            ...
            sws_metrics = self._run_stage_replays(SleepStage.SWS, n_sws, n_timesteps)
            ...
            rem_metrics = self._run_stage_replays(SleepStage.REM, n_rem, n_timesteps)
