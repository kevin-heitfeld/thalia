...
from .population_names import PrefrontalPopulation
from .prefrontal_goal_emergence import EmergentGoalSystem
...
class Prefrontal(NeuralRegion[PrefrontalConfig]):
    ...
    # Mesocortical DA (VTA → PFC) gates working-memory updates (D1 receptor gating).
    # NE from LC regulates prefrontal signal-to-noise (inverted-U relationship).
    # ACh from nucleus basalis drives attentional selection and WM load modulation.
    ...
    def __init__(self, config: PrefrontalConfig, population_sizes: PopulationSizes, region_name: RegionName):
        ...
        # EXTRACT LAYER SIZES
        # =====================================================================
        self.executive_size = population_sizes[PrefrontalPopulation.EXECUTIVE]
    ...
    def forward(self, synaptic_inputs: SynapticInput, neuromodulator_inputs: NeuromodulatorInput) -> RegionOutput:
        ...
        region_outputs: RegionOutput = {
            PrefrontalPopulation.EXECUTIVE: output_spikes,
        }
        ...
        if not GlobalConfig.LEARNING_DISABLED:
            ...
            executive_rec_exc_weights.data.fill_diagonal_(0.0)  # No self-connections
            clamp_weights(executive_rec_exc_weights.data, w_min=cfg.w_min, w_max=cfg.w_max)
