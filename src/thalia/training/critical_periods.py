...
class CriticalPeriodGating:
    ...
    def gate_learning(self, learning_rate: float, domain: str, age: int) -> float:
    ...
    def _compute_multiplier(self, age: int, window: CriticalPeriodWindow) -> float:
    ...
    def get_window_status(self, domain: str, age: int) -> Dict[str, Any]:
