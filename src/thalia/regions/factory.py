...
class RegionRegistry:
    ...
    @classmethod
    def get(cls, name: str) -> Optional[Type[BrainRegion]]:
...
def register_region(
    ...
    *,
    aliases: Optional[List[str]] = None,
) -> Callable[[Type[BrainRegion]], Type[BrainRegion]]:
    ...
    Example:
        ...
        class LayeredCortex(BrainRegion):
            ...
    """
    def decorator(region_class: Type[BrainRegion]) -> Type[BrainRegion]:
...
class RegionFactory:
    ...
    @staticmethod
    def create_batch(
        region_specs: Dict[str, RegionConfig],
