...
References:
    ...
    Redondo, R. L., & Morris, R. G. (2011). Making memories last: the synaptic
...
class SynapticTagging:
    ...
    def reset_tags(self):
        """Clear all tags (for new episode/context).

        In biology: Tags are context-specific and reset between distinct episodes.
        """
        self.tags.zero_()
