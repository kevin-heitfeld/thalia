...
from thalia.config.region_configs import LayeredCortexConfig
...
class LayeredCortex(NeuralRegion):
    ...
    **See Also**:
    ...
    def __init__(
        ...
        # =====================================================================
        # ROBUSTNESS MECHANISMS (from CortexRobustnessConfig)
        # =====================================================================
        ...
        self.register_output_port("l4", self.l4_size)  # Feedforward
    ...
    def _init_robustness_mechanisms(self) -> None:
        """Initialize robustness mechanisms from CortexRobustnessConfig.
