"""
Oscillation Detection Utilities for Neural Activity Analysis.

Provides tools for detecting and measuring oscillatory dynamics in spike trains:
- FFT analysis for frequency detection
- Autocorrelation for periodicity measurement
